    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(error_messages={'unique': 'A user with that username already exists.'}, max_length=150, unique=True, verbose_name='email address')),
            ...
            managers=[
                ('objects', climbers.managers.UserManager()),
            ],
        ),
        migrations.CreateModel(
            name='Measurement',
