...
SECRET_KEY = '(#z$kg=hgsp4mjnb^!&%iep@#r(z1x0ae@h=uvy3i=i+9d+6l9'
...
INSTALLED_APPS = ['dal', 'dal_select2',
    ...
    'climbers.apps.ClimbersConfig', 'workouts.apps.WorkoutsConfig', 'main.apps.MainConfig', 'blog.apps.BlogConfig', ]
...
WSGI_APPLICATION = 'hangboard.wsgi.application'
...
AUTH_USER_MODEL = 'climbers.Climber'
